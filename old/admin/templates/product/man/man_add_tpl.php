                ...
                <div class="card card-primary card-outline text-sm">
                    ...
                    <div class="card-body">
                        <div class="card card-primary card-outline card-outline-tabs">
                                ...
                                <div class="tab-content" id="custom-tabs-three-tabContent-lang">
                                    <?php foreach ($config['website']['lang'] as $k => $v) { ?>
                                        <div class="tab-pane fade show <?= ($k == 'vi') ? 'active' : '' ?>" id="tabs-lang-<?= $k ?>" role="tabpanel" aria-labelledby="tabs-lang">
                                            ...
                                            <div class="form-group">
                                                <label for="location<?= $k ?>">Địa điểm (<?= $k ?>):</label>
                                                <input type="text" class="form-control text-sm" name="data[location<?= $k ?>]" id="location<?= $k ?>" placeholder="Địa điểm (<?= $k ?>)" value="<?= (!empty($flash->has('location' . $k))) ? $flash->get('location' . $k) : @$item['location' . $k] ?>" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="timer<?= $k ?>">Thời gian (<?= $k ?>):</label>
                                                <input type="text" class="form-control text-sm" name="data[timer<?= $k ?>]" id="timer<?= $k ?>" placeholder="Thời gian (<?= $k ?>)" value="<?= (!empty($flash->has('timer' . $k))) ? $flash->get('timer' . $k) : @$item['timer' . $k] ?>" required>
                                            </div>
                            ...
                            <?php if($config['order']['advance'] == true) { ?>
                                <div class="card card-primary card-outline text-sm">
                                    <div class="card-header">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <?php if (isset($config['product'][$type]['regular_price']) && $config['product'][$type]['regular_price'] == true) { ?>
                        <div class="form-group col-md-4">
                            <label class="d-block" for="regular_price">Giá Tour:</label>
                            <div class="input-group">
                                <input type="text" class="form-control format-price regular_price text-sm" name="data[regular_price]" id="regular_price" placeholder="Giá Tour" value="<?= (!empty($flash->has('regular_price'))) ? $flash->get('regular_price') : @$item['regular_price'] ?>">
                    ...
                    <?php if(isset($config['product'][$type]['option']) && $config['product'][$type]['option'] == true) { ?>
                            ...
                            <div class="form-group col-md-4 col-sm-4">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control text-sm" name="data[options][dientich]" id="dientich" placeholder="Diện tích" value="<?=$options['dientich']?>">
                                    <div class="input-group-append">
                            ...
                            <div class="form-group col-md-4 col-sm-4">
                                ...
                                <input type="text" class="form-control" name="data[options][phaply]" id="phaply" placeholder="Pháp lý" value="<?=$options['phaply']?>">
                            </div>

                            <div class="form-group col-md-4 col-sm-4">
                                <label for="nhucau">Nhu cầu:</label>
                                <input type="text" class="form-control" name="data[options][nhucau]" id="nhucau" placeholder="Nhu cầu" value="<?=$options['nhucau']?>">
                            </div>

                            <div class="form-group col-md-4 col-sm-4">
                                <label for="loai">Loại:</label>
                                <input type="text" class="form-control" name="data[options][loai]" id="loai" placeholder="Loại" value="<?=$options['loai']?>">
                            </div>

                            <div class="form-group col-md-4 col-sm-4">
                                <label for="tang">Số tầng:</label>
                                <input type="text" class="form-control" name="data[options][tang]" id="tang" placeholder="Số tầng" value="<?=$options['tang']?>">
                            </div>

                            <div class="form-group col-md-4 col-sm-4">
                                <label for="toa">Tòa:</label>
                                <input type="text" class="form-control" name="data[options][toa]" id="toa" placeholder="Tòa" value="<?=$options['toa']?>">
                            </div>

                            <div class="form-group col-md-4 col-sm-4">
                                <label for="huong">Hướng ban công:</label>
                                <input type="text" class="form-control" name="data[options][huong]" id="huong" placeholder="Hướng ban công" value="<?=$options['huong']?>">
                            </div>

                            <div class="form-group col-md-4 col-sm-4">
                                <label for="phongngu">Phòng ngủ:</label>
                                <input type="text" class="form-control" name="data[options][phongngu]" id="phongngu" placeholder="Phòng ngủ" value="<?=$options['phongngu']?>">
                            </div>

                            <div class="form-group col-md-4 col-sm-4">
                                <label for="phongwc">Phòng wc:</label>
                                <input type="text" class="form-control" name="data[options][phongwc]" id="phongwc" placeholder="Phòng wc" value="<?=$options['phongwc']?>">
                            </div>
