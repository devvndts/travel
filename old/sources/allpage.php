...
$getIntro = $d->rawQueryOne("select id, type,desc$lang, name$lang, content$lang, photo, date_created, date_updated, options from #_static where type = ? limit 0,1", array('gioi-thieu'));
