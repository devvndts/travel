...
/* Tour Trong Nước */
$nametype = "tour-inside";
$config['product'][$nametype]['title_main'] = "Du Lịch Trong Nước";
$config['product'][$nametype]['dropdown'] = true;
$config['product'][$nametype]['list'] = true;
$config['product'][$nametype]['cat'] = true;
$config['product'][$nametype]['item'] = false;
...
$config['product'][$nametype]['comment'] = true;
$config['product'][$nametype]['slug'] = true;
$config['product'][$nametype]['check'] = array("hot"=>"Tour Hot","favorite" => "Tour Favorite", "hienthi" => "Hiển thị");
$config['product'][$nametype]['check_all'] = true;
$config['product'][$nametype]['images'] = true;
$config['product'][$nametype]['show_images'] = true;
$config['product'][$nametype]['gallery'] = array(
...
$config['product'][$nametype]['seo'] = true;
$config['product'][$nametype]['schema'] = true;
$config['product'][$nametype]['width'] =  1920;
$config['product'][$nametype]['height'] = 784;
$config['product'][$nametype]['thumb'] = '1920x784x1';
$config['product'][$nametype]['img_type'] = '.jpg|.gif|.png|.jpeg|.gif';
$config['product'][$nametype]['images2'] = false;
$config['product'][$nametype]['show_images2'] = false;
$config['product'][$nametype]['width2'] = 370;
...
/* Sản phẩm (List) */
$config['product'][$nametype]['title_main_list'] = "Du Lịch Trong Nước cấp 1";
$config['product'][$nametype]['images_list'] = false;
$config['product'][$nametype]['show_images_list'] = false;
$config['product'][$nametype]['slug_list'] = true;
$config['product'][$nametype]['check_list'] = array("noibat" => "Nổi bật", "hienthi" => "Hiển thị");
...
/* Sản phẩm (Cat) */
$config['product'][$nametype]['title_main_cat'] = "Du Lịch Trong Nước cấp 2";
$config['product'][$nametype]['images_cat'] = false;
$config['product'][$nametype]['show_images_cat'] = false;
$config['product'][$nametype]['slug_cat'] = true;
$config['product'][$nametype]['check_cat'] = array("hienthi" => "Hiển thị");//"noibat" => "Nổi bật", 
...
/* Tour Ngoài Nước */
$nametype = "tour-outside";
$config['product'][$nametype]['title_main'] = "Du Lịch Nước Ngoài";
$config['product'][$nametype]['dropdown'] = true;
$config['product'][$nametype]['list'] = true;
$config['product'][$nametype]['cat'] = true;
$config['product'][$nametype]['item'] = false;
...
/* Sản phẩm (List) */
$config['product'][$nametype]['title_main_list'] = "Du Lịch Nước Ngoài cấp 1";
$config['product'][$nametype]['images_list'] = false;
$config['product'][$nametype]['show_images_list'] = false;
$config['product'][$nametype]['slug_list'] = true;
$config['product'][$nametype]['check_list'] = array("noibat" => "Nổi bật", "hienthi" => "Hiển thị");
...
/* Sản phẩm (Cat) */
$config['product'][$nametype]['title_main_cat'] = "Du Lịch Nước Ngoài cấp 2";
$config['product'][$nametype]['images_cat'] = false;
$config['product'][$nametype]['show_images_cat'] = false;
$config['product'][$nametype]['slug_cat'] = true;
$config['product'][$nametype]['check_cat'] = array("hienthi" => "Hiển thị");//"noibat" => "Nổi bật", 
