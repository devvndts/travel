...
$config['photo']['photo_static'][$nametype]['check'] = array("hienthi" => "Hiển thị");
$config['photo']['photo_static'][$nametype]['images'] = true;
$config['photo']['photo_static'][$nametype]['width'] = 213;
$config['photo']['photo_static'][$nametype]['height'] = 49;
$config['photo']['photo_static'][$nametype]['thumb'] = '213x49x2';
$config['photo']['photo_static'][$nametype]['img_type'] = '.jpg|.gif|.png|.jpeg|.gif';
$config['photo']['photo_static'][$nametype]['css_hinh'] = '';//background:#000;padding:10px;
/* Logo Footer */
$nametype = "logo-ft";
...
$config['photo']['photo_static'][$nametype]['check'] = array("hienthi" => "Hiển thị");
$config['photo']['photo_static'][$nametype]['images'] = true;
$config['photo']['photo_static'][$nametype]['width'] = 288;
$config['photo']['photo_static'][$nametype]['height'] = 67;
$config['photo']['photo_static'][$nametype]['thumb'] = '288x67x2';
$config['photo']['photo_static'][$nametype]['img_type'] = '.jpg|.gif|.png|.jpeg|.gif';
$config['photo']['photo_static'][$nametype]['css_hinh'] = '';//background:#000;padding:10px;
...
$config['photo']['photo_static'][$nametype]['height'] = 705;
$config['photo']['photo_static'][$nametype]['thumb'] = '1920x705x1';
$config['photo']['photo_static'][$nametype]['img_type'] = '.jpg|.gif|.png|.jpeg|.gif';
$config['photo']['photo_static'][$nametype]['css_hinh'] = '';//background:#000;padding:10px;
...
/* Ảnh Giới Thiệu */
$nametype = "photo-intro";
$config['photo']['man_photo'][$nametype]['title_main_photo'] = "Ảnh Giới Thiệu";
$config['photo']['man_photo'][$nametype]['check_photo'] = array("hienthi" => "Hiển thị");
$config['photo']['man_photo'][$nametype]['check_all'] = false;
$config['photo']['man_photo'][$nametype]['number_photo'] = 1;
$config['photo']['man_photo'][$nametype]['images_photo'] = true;
...
$config['photo']['man_photo'][$nametype]['link_photo'] = true;
$config['photo']['man_photo'][$nametype]['name_photo'] = true;
$config['photo']['man_photo'][$nametype]['width_photo'] = 310;
$config['photo']['man_photo'][$nametype]['height_photo'] = 480;
$config['photo']['man_photo'][$nametype]['thumb_photo'] = '310x480x1';
$config['photo']['man_photo'][$nametype]['notadd'] = '';//khongthemxoa
$config['photo']['man_photo'][$nametype]['img_type_photo'] = '.jpg|.gif|.png|.jpeg|.gif';
$config['photo']['man_photo'][$nametype]['css_hinh'] = '';//background:#000
/* Ảnh Tiêu Chí */
$nametype = "photo-criteria";
$config['photo']['man_photo'][$nametype]['title_main_photo'] = "Ảnh Tiêu Chí";
$config['photo']['man_photo'][$nametype]['check_photo'] = array("hienthi" => "Hiển thị");
$config['photo']['man_photo'][$nametype]['check_all'] = false;
$config['photo']['man_photo'][$nametype]['number_photo'] = 1;
$config['photo']['man_photo'][$nametype]['images_photo'] = true;
